...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Create a composite index of course_id and is_active.
        db.create_index('teams_courseteam', ['course_id', 'is_active'])
    ...
    def backwards(self, orm):
        # Delete the composite index of course_id and is_active.
        db.delete_index('teams_courseteam', ['course_id', 'is_active'])
